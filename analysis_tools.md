...
| 説明                        | 16進数形式           |
|-----------------------------|---------------------|
| PNG画像ファイル              | `89 50 4E 47`       |
| JPEG画像ファイル             | `FF D8 FF`          |
| GIF画像ファイル              | `47 49 46 38`       |
| PDFファイル                  | `25 50 44 46`       |
| ZIPアーカイブファイル        | `50 4B 03 04`       |
| RARアーカイブファイル        | `52 61 72 21`       |
| ELF実行ファイル              | `7F 45 4C 46`       |
| EXE実行ファイル（Windows）  | `4D 5A`             |
| Javaクラスファイル            | `CA FE BA BE`       |
| 7zアーカイブファイル         | `37 7A BC AF 27 1C` |
